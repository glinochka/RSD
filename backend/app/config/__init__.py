...
class Settings(BaseSettings):
    ...
    CUSTOM_NEUROCOMMENTING_INTERVAL_SECONDS: int = 150
    CUSTOM_SHILLING_INTERVAL_SECONDS: int = 180
    CUSTOM_DISCUSSION_INTERVAL_SECONDS: int = 240
    CUSTOM_LEAD_WARMUP_INTERVAL_SECONDS: int = 90
    CUSTOM_INBOUND_DM_INTERVAL_SECONDS: int = 75
    CUSTOM_ACCOUNT_WARMUP_INTERVAL_SECONDS: int = 900
    CUSTOM_PEER_DIALOG_INTERVAL_SECONDS: int = 900
    CUSTOM_IDLE_BROWSE_INTERVAL_SECONDS: int = 600
    CUSTOM_MOD_PROBE_INTERVAL_SECONDS: int = 900
    CUSTOM_CHAT_ROTATION_INTERVAL_SECONDS: int = 2400
    CUSTOM_SESSION_HYGIENE_INTERVAL_SECONDS: int = 3600
