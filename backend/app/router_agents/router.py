...
.rsd-widget-bubbles{position:absolute;bottom:0;right:70px;display:flex;flex-direction:column-reverse;align-items:flex-end;gap:8px;max-width:min(420px,calc(100vw - 100px));pointer-events:none}
.rsd-widget-root[data-position="bottom-left"] .rsd-widget-bubbles{right:auto;left:70px;align-items:flex-start}
.rsd-widget-bubble{position:relative;width:fit-content;max-width:min(420px,calc(100vw - 100px));background:#fff;border:1px solid #e5e7eb;border-radius:14px 14px 4px 14px;padding:12px 38px 12px 14px;box-shadow:0 8px 24px rgba(15,23,42,.18);font-size:14px;line-height:1.4;color:#111827;cursor:pointer;animation:rsd-in .3s ease;pointer-events:auto;transition:transform .28s ease,opacity .22s ease}
