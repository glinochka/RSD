...
async def compose_outreach_dm(
    *,
    ...
    prompt = (
        "Напиши первое холодное сообщение в мессенджер (Telegram/WhatsApp) от имени менеджера RSD.\n\n"
        ...
        "5) Если нужны правки — напишите, сделаем.\n"
        f"6) Можно связаться по номеру {AI_MOP_CONTACT_PHONE} (МАКС, Telegram, WhatsApp).\n\n"
        "Правила:\n"
