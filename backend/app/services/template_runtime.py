    ...
    async def _execute_crm_admin(
        ...
        *,
        ...
        system_prompt = (
            ...
            "используй cancel_appointment или reschedule_appointment с полем appointment_date (дата/время записи) — система найдёт запись автоматически по пользователю и дате. "
