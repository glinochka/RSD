...
export const API_ROUTES = {
  ...
  CUSTOM_AUTOMATION_CHAT_FOLDERS: (id) => `/api/custom/automations/${id}/chats/folders`,
  CUSTOM_AUTOMATION_CHAT_FOLDER: (id, folderId) => `/api/custom/automations/${id}/chats/folders/${folderId}`,
...
export const NAVIGATION_ROUTES = {
  ...
  CUSTOM_AUTOMATION_ERRORS: (id) => `/custom/automations/${id}/errors`,
