...
const ROUTES = {
  ...
  '/pricing': {
    title: 'Тарифы и цены | RSD',
    description:
      'Тарифы RSD: выберите план для ИИ-агентов с опорой на ваши документы. Прозрачные условия для поддержки, продаж и внутренних процессов.',
  },
  '/documentation': {
