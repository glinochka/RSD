...
const DEFAULT_TITLE = 'RSD AI - Портал для цифровизации вашего бизнеса: ИИ-агенты, сайты, CRM';
const DEFAULT_DESCRIPTION =
  'RSD AI — портал для цифровизации бизнеса без программистов. Собирайте ИИ-агентов для поддержки и продаж на ваших документах, создавайте сайты в AI-конструкторе и ведите клиентов в CRM — всё в одном сервисе, запуск за минуты.';
...
const ROUTES = {
  ...
  '/pricing': {
    ...
    description:
      'Цены RSD: ИИ консультант бесплатно, ИИ Администратор — 990 ₽/мес, ИИ МОП — 1 990 ₽/мес. 3 дня trial, токены LLM включены.',
  },
  '/documentation': {
...
const PRIVATE_PREFIXES = ['/agents', '/create-agent', '/create-agent-ai', '/projects'];
